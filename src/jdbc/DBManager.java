...
public class DBManager {
	...
	public void createTables() {
		try {
			...
			String sql1 = "CREATE TABLE departments " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " name     TEXT     NOT NULL, " + " address  TEXT	 NOT NULL)";
			stmt1.executeUpdate(sql1);
			stmt1.close();
			Statement stmt2 = c.createStatement();
			String sql2 = "CREATE TABLE employees " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " name     TEXT     NOT NULL, " + " dob      DATE	 NOT NULL, " + " address  TEXT, "
					+ " salary   REAL," + " photo	BLOB,"
			...
			String sql3 = "CREATE TABLE reports " + "(id       INTEGER  PRIMARY KEY AUTOINCREMENT,"
					+ " name     TEXT     NOT NULL, " + " content  TEXT  	NOT NULL, " + " date		DATE)";
